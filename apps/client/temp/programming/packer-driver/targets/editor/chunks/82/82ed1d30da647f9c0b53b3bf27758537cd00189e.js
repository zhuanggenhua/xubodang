    ...
    execute: function () {
      ...
      _export("HomeMgr", HomeMgr = (_dec = ccclass('HomeMgr'), _dec2 = property(Prefab), _dec(_class = (_class2 = class HomeMgr extends Component {
        ...
        onLoad() {
          ...
          let spacing = (_crd && mapW === void 0 ? (_reportPossibleCrUseOfmapW({
            error: Error()
          ...
          for (let i = 0; i < 10; i++) {
            ...
            let posX = spacing * (i + 1) - (_crd && mapW === void 0 ? (_reportPossibleCrUseOfmapW({
              error: Error()
            }), mapW) : mapW) / 2; // 计算每个粒子的X坐标位置

            let posY = -(_crd && mapH === void 0 ? (_reportPossibleCrUseOfmapH({
              error: Error()
