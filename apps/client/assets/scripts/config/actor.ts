    ...
    skills: {
      ...
      3: [
        ...
        },
        {
          name: '气功炮',
          type: [1, 5],
          desc: '用所有的气造成伤害，下回合无法行动(每点额外的气使得伤害+1)',
          damage: 5,
          range: ['02'],
          longrang: true,
          speed: 0,
